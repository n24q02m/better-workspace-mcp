...
export async function handleAccountCallback(req: IncomingMessage, res: ServerResponse): Promise<void> {
  ...
  try {
    ...
    respond(res, 200, 'Account added', `${email} is now connected. You can close this tab (<kbd>Cmd/Ctrl + W</kbd>).`)
  } catch (err) {
