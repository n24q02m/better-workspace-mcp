...
const CALLBACK_CSS =
  'body{font-family:system-ui,sans-serif;max-width:34rem;margin:4rem auto;padding:0 1rem;line-height:1.5;text-align:center}main{display:flex;flex-direction:column;align-items:center}.main-content{display:flex;flex-direction:column;align-items:center;animation:fadeInUp 0.4s ease-out}.feedback-icon{width:3rem;height:3rem;margin-bottom:1rem}.feedback-icon--success{color:#059669}.feedback-icon--error{color:#dc2626}h1{margin-top:0}code{background-color:rgba(150,150,150,0.2);padding:0.2rem 0.4rem;border-radius:0.25rem;font-family:monospace;word-break:break-all}kbd{background-color:rgba(150,150,150,0.2);padding:0.1rem 0.3rem;border-radius:0.25rem;font-family:system-ui;font-size:0.9em;border:1px solid rgba(150,150,150,0.4);box-shadow:0 1px 1px rgba(0,0,0,0.1)}@keyframes fadeInUp{from{opacity:0;transform:translateY(10px)}to{opacity:1;transform:translateY(0)}}@media (prefers-reduced-motion:reduce){.main-content{animation:none}}'
