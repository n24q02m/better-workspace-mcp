...
function respond(res: ServerResponse, status: number, title: string, detail: string): void {
  // Added <meta name="color-scheme" content="light dark"> for automatic dark mode support
  // Added <main> semantic tag to body
  ...
  // Security headers to mitigate XSS and clickjacking
