...
export class MimeHelper {
  ...
  public static createMimeMessage({
    ...
    // PERFORMANCE: Native base64url encoding is ~2.5x faster than regex replacements
  ...
  public static decodeBase64Url(encoded: string): string {
    // PERFORMANCE: Native base64url decoding is ~2x faster than regex replacements
