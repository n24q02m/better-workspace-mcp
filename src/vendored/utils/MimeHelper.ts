...
export class MimeHelper {
  ...
  public static createMimeMessage({
    ...
    // Optimized: native base64url is significantly faster than regex replacements
  ...
  public static decodeBase64Url(encoded: string): string {
    // Optimized: native base64url decoding handles padding and alphabet translation in C++
