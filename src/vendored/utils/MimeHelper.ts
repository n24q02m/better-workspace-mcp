...
export class MimeHelper {
  ...
  public static createMimeMessage({
    ...
    // ⚡ Bolt: Use native base64url string encoding for better performance and less memory overhead
  ...
  public static decodeBase64Url(encoded: string): string {
    // ⚡ Bolt: Use native base64url decoding for better performance and less memory overhead
